        ...
        if ($platform->status) {
            ...
            try {
                ...
                foreach ($winds as $wind_member) {
                    ...
                    $this->addUsertoGroup($wind_member->user_id, "earth", $this->new_group_id);
                }
                ...
                foreach ($fires as $fire_member) {
                    ...
                    $this->addUsertoGroup($fire_member->user_id, "wind", $this->new_group_id);
                }

                //assign proper number of member for both group
                Group::where('id', $earths->group_id)->update(['members_number' => 7, 'status' => "open"]);
